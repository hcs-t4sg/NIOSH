...
const LabDataCompare: React.FC = (props) => {
  ...
  const room302_temp = [{x: 8, y: 11}, {x: 130, y: 20}, {x: 250, y: 18}, {x: 450, y: 50}, {x: 490, y: 47},{x: 675, y: 80} ]
  const room302_hum = [{x: 18, y: 11}, {x: 110, y: 20}, {x: 210, y: 18}, {x: 410, y: 50}, {x: 510, y: 47},{x: 610, y: 80} ]
  const b15_hum = [{x: 38, y: 11}, {x: 160, y: 20}, {x: 280, y: 18}, {x: 490, y: 50}, {x: 560, y: 47},{x: 620, y: 80} ]
      ...
      >
        ...
        <Menu
            ...
            {labsData.map((lab, index) => {
                      return (
                        <MenuItem key={index} value={index} onClick={handleClose}>{lab}</MenuItem>
                )})} 
        </Menu>
